...
class ObjectsRoomDataset(Dataset):
    ...
    def get_files(self):
        img_files = sorted(glob(f'{self.data_root}/{self.split}/images/*.png'))
        return img_files
...
class ObjectsRoomDataModule(pl.LightningDataModule):
    def __init__(
        ...
        self.train_dataset = ObjectsRoomDataset(args.data_root, 'train', args.use_rescale)
        self.val_dataset = ObjectsRoomDataset(args.data_root, 'val', args.use_rescale)
        self.test_dataset = ObjectsRoomDataset(args.data_root, 'test', args.use_rescale)
