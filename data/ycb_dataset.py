...
class YCBDataModule(pl.LightningDataModule):
    def __init__(
        ...
        self.train_dataset = YCBDataset(args.data_root, args.split_name, 'train', args.use_rescale)
        self.val_dataset = YCBDataset(args.data_root, args.split_name, 'test', args.use_rescale)
        self.test_dataset = YCBDataset(args.data_root, args.split_name, 'test', args.use_rescale)
...
if __name__ == '__main__':
    ...
    args.data_root = '/scratch/generalvision/ObjectCentric/YCB'
    args.use_rescale = False
    args.batch_size = 20
    args.num_workers = 0
    args.split_name = 'image'

    datamodule = YCBDataModule(args)
